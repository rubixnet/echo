...
- searching from history should update the search at, and add clear history back again
...
- option for the user to logout, we have a route for this as well! 
- creating the lyrics engine or hosting the lyrics ourself and using it in our own application. 
- 
...
- show songs only in search, option to pin playlists, 
- making sure to show that the user is hosting like a popup or somewhere so that it works when the user is present 
