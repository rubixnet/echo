...
export default function Onboarding({ user }: { user?: any }) {
  ...
  // Automatically load data from the user object if they are returning
  useEffect(() => {
    if (user) {
  ...
  const handleCustomAvatarUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      setAvatarUrl(url); // Set local blob URL for immediate UI preview
    }
  };
          ...
          <div className="space-y-10">
            <div>
              ...
              <p className="text-sm font-medium text-foreground/50 mt-2 max-w-lg">
                This is how friends see you in rooms and shared feeds. No real names required.
              </p>
            </div>
        ...
        {step === 2 && (
          <div className="space-y-8">
            <div>
              ...
              <p className="text-sm font-medium text-foreground/50 mt-2 max-w-lg">
                Pick up to 5 genres to calibrate your initial Echo feed and live recommendations.
              </p>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-6 rounded-md border border-foreground/10 flex flex-col justify-between min-h-[200px]">
                <span className="text-xs font-mono text-foreground/40">01 // LIVE</span>
                <div>
                  <h3 className="text-lg font-bold tracking-tight">Sync Playback</h3>
                  <p className="text-xs text-foreground/50 mt-1 leading-relaxed">
                    Listen to tracks in exact lock-step with friends in real-time.
                  </p>
                </div>
              </div>

              <div className="p-6 rounded-md border border-foreground/10 flex flex-col justify-between min-h-[200px]">
                <span className="text-xs font-mono text-foreground/40">02 // ACTIVITY</span>
                <div>
                  <h3 className="text-lg font-bold tracking-tight">Live Activity Feed</h3>
                  <p className="text-xs text-foreground/50 mt-1 leading-relaxed">
                    See what tracks your inner circle is bumping directly from the sidebar.
                  </p>
                </div>
              </div>

              <div className="p-6 rounded-md border border-foreground/10 flex flex-col justify-between min-h-[200px]">
                <span className="text-xs font-mono text-foreground/40">03 // SOCIAL</span>
                <div>
                  <h3 className="text-lg font-bold tracking-tight">Shared Libraries</h3>
                  <p className="text-xs text-foreground/50 mt-1 leading-relaxed">
                    Explore favorite songs, check play history, and clone playlists.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
              ...
              <div className="md:col-span-4 p-6 rounded-md border border-foreground/10 flex flex-col justify-between min-h-[180px]">
                ...
                <div>
                  <h3 className="text-lg font-bold tracking-tight">Taste Overlap</h3>
                  <p className="text-xs text-foreground/50 mt-1">
