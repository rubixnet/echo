      ...
      <div className="p-6 max-w-6xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="h-40 bg-foreground/5 animate-pulse rounded-2xl"
            />
          ))}
        </div>
      </div>
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 pb-4 border-b border-foreground/5">
        <div>
          ...
          <p className="text-xs text-foreground/50 mt-1">
            Tune into active sessions or start your own.
          </p>
        </div>
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="flex flex-col min-w-0">
                    ...
                    <p className="text-[10px] text-foreground/50 truncate mt-0.5 font-medium uppercase tracking-wider">
                      Host: {room.hostId.slice(-6)}
                    </p>
                  </div>
                  <div
                    className={cn(
