    ...
    return (
        ...
        >
            <div
                ...
                style={{
                    boxShadow: "inset 0 -1px 4px 0 rgba(255, 255, 255, 0.2), 0 3px 5px 0 rgba(0, 0, 0, 0.4)",
                }}
            >
                <div
                    ...
                    style={{
                        ...
                        background: "linear-gradient(180deg, rgba(255,255,255,0.08) 0%, rgba(48,48,48,0.65) 60%, rgba(51,51,51,0.8) 100%)",
                    }}
                />
                <div
                    className="absolute inset-0 z-10 rounded-(--liquid-radius) pointer-events-none"
                    style={{
                        background: "linear-gradient(0deg, rgba(255,255,255,0.15) 0%, transparent 2%)",
                ...
                >
                    <div
                        ...
                        style={{
                            padding: "1px",
                            background: "linear-gradient(180deg, rgba(255,255,255,0.1) 0%, rgba(255,255,255,0.1) 30%, rgba(255,255,255,0) 50%, rgba(255,255,255,0.1) 70%, rgba(255,255,255,0.1) 100%)",
            ...
            >
                <div
                    ...
                    style={{
                        backdropFilter: "blur(24px) saturate(150%)",
                        WebkitBackdropFilter: "blur(24px) saturate(150%)",
                        background: "linear-gradient(180deg, rgba(255,255,255,0.85) 0%, rgba(255,255,255,0.6) 60%, rgba(255,255,255,0.4) 100%)",
                    }}
                />
                <div
                    className="absolute inset-0 z-10 rounded-(--liquid-radius) pointer-events-none"
