...
export function DesktopMiniPlayer({ isDrawerOpen, setIsDrawerOpen, setIsPlaylistModalOpen }: DesktopMiniPlayerProps) {
    ...
    return (
        <>
            <div className={cn("fixed bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-background via-background/80 to-transparent pointer-events-none z-[997] transition-opacity duration-300", isDrawerOpen ? "opacity-0" : "opacity-100")} />
