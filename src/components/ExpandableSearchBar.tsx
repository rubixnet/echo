...
export function ExpandableSearchBar<T extends string = string>({
    ...
    const hasFilters = Boolean(filterOptions && filterOptions.length > 0 && onFilterChange);
    ...
    return (
        ...
        >
            <LiquidContainer
                radius="50px"
                className="h-11 w-full shadow-none relative overflow-hidden transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)]"
            >
                <div
                    className={cn(
                        "absolute inset-0 flex items-center justify-end px-1 transition-all duration-200 ease-out",
                        isExpanded
