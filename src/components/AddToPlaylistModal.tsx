        ...
        <LiquidPanel radius="24px">
          ...
          <div className="px-6 pt-6 pb-4">
            ...
            {normalized.id ? (
              ...
              <div className="flex items-center gap-2 bg-rose-500/10 text-rose-500 p-3 rounded-xl">
                <AlertCircle size={16} />
                <p className="text-xs font-semibold">Please wait for the track to load.</p>
              </div>
            )}
          </div>
          ...
          <div className="px-5 pb-5 space-y-5">
            ...
            <div className="flex flex-col gap-1.5">
              <h4 className="text-[10px] font-bold text-foreground/40 uppercase tracking-widest px-1 mb-1">Your Playlists</h4>
