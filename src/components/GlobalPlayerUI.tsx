...
import { Play, Pause, SkipForward, SkipBack, Volume2, VolumeX, Heart, Loader2, Music, MoreHorizontal, ListPlus, PlusCircle } from "lucide-react";
...
export default function GlobalPlayer({ user }: { user?: any }) {
    ...
    return (
        <div className="absolute bottom-0 left-0 md:left-64 right-0 px-4 md:px-8 pb-4 md:pb-6 z-[9999] pointer-events-none transition-all duration-300">
                    ...
                    {activeMetadata ? (
                        <>
                            ...
                            <div className="hidden sm:flex items-center min-w-0 pr-4">
                                ...
                                <button 
                                    onClick={handleLike}
                                    className="ml-2 w-8 h-8 flex items-center justify-center rounded-full hover:bg-neutral-100 transition-colors focus:outline-none"
                                >
